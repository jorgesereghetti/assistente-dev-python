# Estudo de Caso 1 - Coder - Criando Seu Assistente de Programação Python, em Python
...
st.title("Data Science Academy - Coder")
...
st.markdown(
    ...
    <div style="text-align: center; color: gray;">
        <hr>
        <p>Coder - Parte Integrante do Curso Gratuito Fundamentos de Linguagem Python da Data Science Academy</p>
    </div>
    """,
